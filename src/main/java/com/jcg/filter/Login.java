 ...
 * 
 * Description  : This file is responsible HttpFilter
 * 
 * Date  							Author   										  Changes
 * ------------------------------------------------------------------------------------------
 * 07-AUG-2019						Akash Chandra Singh						          initial
 * 
 * All rights reserved RJIL 2018
 *********************************************************************************************/
...
public class Login implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chainObj)
		...
		if (password != null && password.equals("admin")) {
			...
			rdObj = req.getRequestDispatcher("/index.html");
